  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all GuLiCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific GuLiCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new GuLiCode session for interacting with AI assistants and managing conversations.",
