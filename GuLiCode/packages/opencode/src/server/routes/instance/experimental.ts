  ...
  new Hono()
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Persist a new active Console account/org selection for the current local GuLiCode state.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description:
          "Get a list of all GuLiCode sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
