...
export const dict = {
  ...
  "blueprint.runtime.planning": "启动计划和直接运行",
  ...
  "blueprint.runtime.task": "任务",
  "blueprint.runtime.taskPlaceholder": "输入这次蓝图运行要完成的任务。",
  "blueprint.runtime.taskRequired": "提交前必须填写任务。",
  "blueprint.runtime.generatePlan": "生成启动计划",
  "blueprint.runtime.planPreview": "启动计划",
  "blueprint.runtime.startPlanRequired": "请先生成并通过校验启动计划。",
