...
export const dict = {
  ...
  "blueprint.runtime.planning": "起始节点、任务规划和直接运行",
  "blueprint.runtime.startNodes": "起始节点",
  "blueprint.runtime.startNodesTopAgent": "由 Top Agent 在规划时选择",
  ...
  "blueprint.runtime.directRun": "运行",
  ...
  "blueprint.progress.planning": "Top Agent 正在生成蓝图计划",
  ...
  "blueprint.add.tick.description": "按不高于框架 tick 的间隔发出节拍",
  ...
  "blueprint.field.everyNTicks": "每 N 个 tick",
  ...
  "blueprint.common.tickSubtitle": "每 {{n}} 个框架 tick",
  ...
  "blueprint.tip.everyNTicks.what": "以框架 tick 计量的 Tick 间隔。",
  "blueprint.tip.everyNTicks.usage": "设置为 1 表示每个框架 tick 触发一次；更大的整数表示更低频率。",
