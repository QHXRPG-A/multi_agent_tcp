...
export const dict = {
  ...
  "blueprint.runtime.planning": "起始節點、任務規劃和直接執行",
  "blueprint.runtime.startNodes": "起始節點",
  "blueprint.runtime.startNodesTopAgent": "由 Top Agent 在規劃時選擇",
  ...
  "blueprint.runtime.directRun": "執行",
  ...
  "blueprint.progress.planning": "Top Agent 正在產生藍圖計劃",
  ...
  "blueprint.add.tick.description": "以不高於框架 tick 的間隔發出節拍",
  ...
  "blueprint.field.everyNTicks": "每 N 個 tick",
  ...
  "blueprint.common.tickSubtitle": "每 {{n}} 個框架 tick",
  ...
  "blueprint.tip.everyNTicks.what": "以框架 tick 計量的 Tick 間隔。",
  "blueprint.tip.everyNTicks.usage": "設為 1 表示每個框架 tick 觸發一次；更大的整數表示較低頻率。",
