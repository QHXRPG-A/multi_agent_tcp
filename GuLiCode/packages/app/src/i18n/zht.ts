...
export const dict = {
  ...
  "blueprint.ring.title": "環列表",
  "blueprint.ring.settings": "環設定",
  "blueprint.ring.empty": "暫無 Agent 環",
  "blueprint.ring.back": "返回",
  "blueprint.ring.agents": "個 Agent",
  "blueprint.ring.maxCirculations": "最大流轉次數",
  "blueprint.ring.contextRefreshPeriod": "刷新週期",
  "blueprint.ring.remaining": "剩餘次數",
  "blueprint.ring.generation": "Generation",
  "blueprint.ring.completed": "已完成閉環",
  "blueprint.ring.lastRefresh": "上次刷新",
  "blueprint.ring.runningReadOnly": "藍圖執行中環設定只讀，修改會在下一次執行生效。",
  ...
  "blueprint.document.delete": "刪除藍圖",
  "blueprint.document.deleteTitle": "刪除藍圖",
  "blueprint.document.deleteConfirm": '刪除藍圖 "{{name}}"？',
  "blueprint.document.deleteFailed": "藍圖刪除失敗",
  "blueprint.document.loadFailed": "藍圖載入失敗",
  "blueprint.document.empty": "暫無專案藍圖",
  "blueprint.sessions.title": "藍圖會話",
  "blueprint.sessions.button": "會話 {{count}}",
  "blueprint.sessions.refresh": "重新整理會話",
  "blueprint.sessions.empty": "暫無藍圖會話",
  "blueprint.sessions.running": "執行中",
  "blueprint.sessions.restart": "重啟會話並套用目前藍圖結構",
  "blueprint.sessions.delete": "刪除會話",
  "blueprint.sessions.deleteRunning": "執行中的會話不能刪除",
  "blueprint.sessions.unknownBlueprint": "未知藍圖",
  ...
  "blueprint.runtime.planning": "藍圖會話",
  "blueprint.runtime.startNodes": "起始節點",
  "blueprint.runtime.startNode": "起始節點",
  ...
  "blueprint.runtime.sessionMessagePlaceholder": "向目前藍圖會話發送任務訊息",
  "blueprint.runtime.sessionMessageSubmit": "發送到會話",
  ...
  "blueprint.runtime.currentSession": "目前會話",
  "blueprint.runtime.running": "進行中",
  "blueprint.runtime.notRunning": "未執行",
  "blueprint.runtime.terminateSession": "終止會話",
  "blueprint.runtime.terminateSessionDescription": "只結束目前會話",
  "blueprint.runtime.clearSession": "清理目前會話",
  "blueprint.runtime.clearSessionDescription": "結束目前會話並清空聊天和填表歷史",
  "blueprint.runtime.clearSessionTitle": "清理目前會話",
  "blueprint.runtime.clearSessionConfirm": "確認清理會話 {{name}}？",
  "blueprint.runtime.clearSessionWarning": "只會清空目前會話的聊天記錄和填表記錄，不會刪除其他會話或 workbook 檔案。",
  ...
  "blueprint.add.prompt.description": "追加到 Agent 輸入的可重用提示詞",
  ...
  "blueprint.context.scriptSettings": "腳本設定",
  ...
  "blueprint.field.promptText": "提示詞文本",
  "blueprint.field.promptTrigger": "觸發方式",
  "blueprint.field.expanded": "展開",
  ...
  "blueprint.field.blueprintMonitorTools": "藍圖監管工具",
  "blueprint.field.popoEntry": "POPO 機器人入口",
  "blueprint.field.popoEntryEnabled": "啟用 POPO 入口",
  "blueprint.field.popoRobotAppKey": "機器人 AppKey",
  "blueprint.field.popoRobotName": "機器人名稱",
  "blueprint.field.popoRobotAppSecret": "機器人 AppSecret",
  "blueprint.field.popoCallbackToken": "回調 Token",
  "blueprint.field.popoAesKey": "AES Key",
  "blueprint.popoEntry.startNodeOnly": "只有保存的起始 full Agent 可以啟用 POPO 訊息轉發。",
  "blueprint.popoEntry.lockedByAgent": "full Agent {nodeId} 已經啟用 POPO 訊息轉發。",
  "blueprint.popoEntry.activeBadge": "POPO 藍圖",
  ...
  "blueprint.field.scriptFeedbackOnly": "回傳給呼叫方",
  "blueprint.field.scriptRequireCallBeforeDispatch": "呼叫後才可派發",
  ...
  "blueprint.prompt.empty": "空提示詞",
  "blueprint.prompt.placeholder": "追加提示詞...",
  "blueprint.prompt.trigger.once": "1次觸發",
  "blueprint.prompt.trigger.always": "多次觸發",
  "blueprint.agent.expand": "展開 Agent 端口",
  ...
  "blueprint.resident.panelTitle": "常駐服務",
  ...
  "blueprint.resident.searchPlaceholder": "搜尋常駐服務",
  "blueprint.resident.noMatches": "無匹配常駐服務",
  "blueprint.resident.pageStatus": "{{page}} / {{total}}",
  "blueprint.resident.firstPage": "第一頁",
  "blueprint.resident.previousPage": "上一頁",
  "blueprint.resident.nextPage": "下一頁",
  "blueprint.resident.lastPage": "最後一頁",
  "blueprint.resident.expand": "展開常駐服務",
  "blueprint.resident.collapse": "收起常駐服務",
  "blueprint.resident.noDescription": "未描述",
  "blueprint.resident.noLogs": "暫無日誌",
  "blueprint.resident.clearView": "清空視圖",
  "blueprint.resident.start": "開始",
  "blueprint.resident.stop": "結束",
  "blueprint.resident.create": "建立常駐服務",
  "blueprint.resident.createTitle": "建立常駐服務",
  "blueprint.resident.name": "服務名",
  "blueprint.resident.description": "服務描述",
  "blueprint.resident.descriptionPlaceholder": "可留空。Agent 與 Worker 節點可見。",
  "blueprint.resident.templateHint": "會在全域 resident_services 目錄中建立 Python 服務模板。",
  "blueprint.resident.createFailed": "常駐服務建立失敗",
  "blueprint.resident.openSuccess": "已開啟常駐服務目錄",
  "blueprint.resident.openFailed": "開啟常駐服務失敗",
  "blueprint.resident.startFailed": "常駐服務啟動失敗",
  "blueprint.resident.stopFailed": "常駐服務結束失敗",
  "blueprint.control.open": "開啟藍圖控制面板",
  "blueprint.control.close": "關閉藍圖控制面板",
  "blueprint.control.title": "藍圖控制",
  "blueprint.control.subtitle": "外掛級全域服務與歷史記錄",
  "blueprint.excelHistory.title": "策劃填表記錄",
  "blueprint.excelHistory.subtitle": "按會話查看策劃表格填寫歷史",
  "blueprint.excelHistory.refresh": "重新整理填表記錄",
  "blueprint.excelHistory.empty": "目前藍圖暫無填表記錄",
  "blueprint.excelHistory.unavailable": "目前 Workbench 不支援查看填表記錄。",
  "blueprint.excelHistory.recordCount": "{{count}} 條",
  "blueprint.excelHistory.totalRecords": "共 {{count}} 條記錄",
  "blueprint.excelHistory.detailTitle": "填表記錄：{{name}}",
  "blueprint.excelHistory.noRecords": "未找到填表記錄。",
  "blueprint.excelHistory.truncated": "僅展示最近的記錄。",
  "blueprint.excelHistory.time": "時間",
  "blueprint.excelHistory.status": "狀態",
  "blueprint.excelHistory.statusSucceeded": "成功",
  "blueprint.excelHistory.statusFailed": "失敗",
  "blueprint.excelHistory.workbook": "表格",
  "blueprint.excelHistory.command": "命令",
  "blueprint.excelHistory.location": "行列",
  "blueprint.excelHistory.beforeAfter": "舊值/新值單元格：{{count}}",
  "blueprint.fileSendHistory.title": "檔案圖片發送記錄",
  "blueprint.fileSendHistory.subtitle": "按會話查看 POPO 檔案/圖片發送歷史",
  "blueprint.fileSendHistory.refresh": "重新整理檔案記錄",
  "blueprint.fileSendHistory.empty": "目前藍圖暫無檔案/圖片發送記錄",
  "blueprint.fileSendHistory.unavailable": "目前 Workbench 不支援查看檔案發送記錄。",
  "blueprint.fileSendHistory.recordCount": "{{count}} 條",
  "blueprint.fileSendHistory.totalRecords": "共 {{count}} 條記錄",
  "blueprint.fileSendHistory.detailTitle": "檔案圖片發送記錄：{{name}}",
  "blueprint.fileSendHistory.noRecords": "未找到檔案/圖片發送記錄。",
  "blueprint.fileSendHistory.truncated": "僅展示最近的記錄。",
  "blueprint.fileSendHistory.time": "時間",
  "blueprint.fileSendHistory.type": "類型",
  "blueprint.fileSendHistory.status": "狀態",
  "blueprint.fileSendHistory.statusSucceeded": "成功",
  "blueprint.fileSendHistory.statusFailed": "失敗",
  "blueprint.fileSendHistory.fileName": "檔案名",
  "blueprint.fileSendHistory.size": "大小",
  "blueprint.fileSendHistory.receiver": "接收人",
  "blueprint.fileSendHistory.path": "路徑",
  "blueprint.popoService.title": "POPO 回調服務",
  "blueprint.popoService.subtitle": "設定回調服務接受轉發的全域機器人入口。",
  "blueprint.popoService.refresh": "重新整理 POPO 回調服務",
  "blueprint.popoService.status": "服務狀態",
  "blueprint.popoService.callbackUrl": "回調 URL 模板",
  "blueprint.popoService.legacyUrl": "舊版回調 URL",
  "blueprint.popoService.healthUrl": "健康檢查",
  "blueprint.popoService.robots": "機器人入口",
  "blueprint.popoService.addRobot": "新增機器人",
  "blueprint.popoService.empty": "暫無 POPO 機器人設定",
  "blueprint.popoService.enabled": "啟用該機器人",
  "blueprint.popoService.advanced": "回調憑證",
  "blueprint.popoService.save": "儲存機器人",
  "blueprint.popoService.delete": "刪除機器人",
  "blueprint.popoService.appKeyPlaceholder": "Robot AppKey",
  "blueprint.popoService.namePlaceholder": "機器人名稱",
  ...
  "blueprint.popoService.saveFailed": "儲存 POPO 機器人失敗",
  "blueprint.popoService.deleteFailed": "刪除 POPO 機器人失敗",
  "blueprint.popoService.toggleFailed": "更新 POPO 機器人失敗",
  ...
  "blueprint.tip.promptText.what": "透過提示詞資料邊追加到 Agent 的文本。",
  "blueprint.tip.promptText.usage": "將此提示詞節點連接到已啟用的 Agent prompt 輸入，執行時會在派發訊息前前置該文本。",
  "blueprint.tip.promptTrigger.what": "此提示詞節點前置到 Agent 訊息的頻率。",
  "blueprint.tip.promptTrigger.usage": "1次觸發會在每次執行內每個 Agent 第一則非空訊息注入；多次觸發會在每次派發時注入。",
  ...
  "blueprint.tip.disableSandbox.usage": "完整 Agent 預設開啟。Worker 仍會拒絕危險沙盒繞過設定。",
