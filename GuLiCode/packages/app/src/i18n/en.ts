export const dict = {
  ...
  "blueprint.tip.prompt.what": "The task instruction sent to the agent when the node runs.",
  "blueprint.tip.prompt.usage": "Describe the agent's responsibility, constraints, and expected output.",
