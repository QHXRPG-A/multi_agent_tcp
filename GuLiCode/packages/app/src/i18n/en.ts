export const dict = {
  ...
  "blueprint.runtime.planning": "Start plan and direct run",
  ...
  "blueprint.runtime.task": "Task",
  "blueprint.runtime.taskPlaceholder": "Describe the task for this blueprint run.",
  "blueprint.runtime.taskRequired": "Enter a task before submitting.",
  "blueprint.runtime.generatePlan": "Generate start plan",
  "blueprint.runtime.planPreview": "Start plan",
  "blueprint.runtime.startPlanRequired": "Generate and validate a start plan first.",
