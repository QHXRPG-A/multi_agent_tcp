...
export function SessionSidePanel(props: {
  ...
  const panelWidth = createMemo(() => {
    if (!open()) return "0px"
    if (mainOpen()) return `calc(100% - ${layout.session.width()}px)`
    ...
    <Show when={isDesktop()}>
      ...
      >
        <div class="size-full flex border-l border-border-weaker-base">
          <div
            aria-hidden={!mainOpen()}
            inert={!mainOpen()}
            class="relative min-w-0 h-full flex-1 overflow-hidden bg-background-base"
            classList={{
              "pointer-events-none": !mainOpen(),
            }}
          >
          ...
          <Show when={shown()}>
            ...
            >
              <div
                ...
                classList={{ "border-l border-border-weaker-base": mainOpen() }}
              >
                <Tabs
                  variant="pill"
                  value={fileTreeTab()}
