export const dict = {
  ...
  "desktop.menu.help.documentation": "GuLiCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "GuLiCode CLI binary is missing. Try reinstalling the desktop app.",
