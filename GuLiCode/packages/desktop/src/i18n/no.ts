export const dict = {
  ...
  "desktop.menu.help.documentation": "GuLiCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "GuLiCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
