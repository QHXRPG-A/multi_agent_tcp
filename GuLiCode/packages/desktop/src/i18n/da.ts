export const dict = {
  ...
  "desktop.menu.help.documentation": "GuLiCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "GuLiCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
