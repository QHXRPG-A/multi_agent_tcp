...
export type ElectronAPI = {
  ...
  blueprintDetectPython: (projectDir?: string, pythonCommand?: string) => Promise<Record<string, unknown>>
  blueprintConfigureRuntime: (pythonPath?: string) => Promise<Record<string, unknown>>
