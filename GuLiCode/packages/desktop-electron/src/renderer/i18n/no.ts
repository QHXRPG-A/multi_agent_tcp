export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av GuLiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av GuLiCode er lastet ned. Vil du installere den og starte på nytt?",
