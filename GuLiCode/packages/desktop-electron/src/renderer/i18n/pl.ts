export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji GuLiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} GuLiCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
