export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af GuLiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af GuLiCode er blevet downloadet. Vil du installere den og genstarte?",
