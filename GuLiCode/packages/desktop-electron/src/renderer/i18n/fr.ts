export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'GuLiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'GuLiCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
