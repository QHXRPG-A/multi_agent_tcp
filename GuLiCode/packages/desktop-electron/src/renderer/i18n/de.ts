export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von GuLiCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von GuLiCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
