...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>GuLiCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="GuLiCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to GuLiCode. Please read on to learn the rules and restrictions that govern your use of
                GuLiCode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("GuLiCode," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is GuLiCode?</h2>
              <p>
                GuLiCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the GuLiCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, GuLiCode enables you to
              ...
              <p>
                GuLiCode takes the privacy of its users very seriously. For the current GuLiCode Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using GuLiCode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by GuLiCode;
                </li>
                <li>
              ...
              <p>
                If you use GuLiCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                GuLiCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                GuLiCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will GuLiCode ever change the Services?</h2>
              <p>
              ...
              <p>
                GuLiCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. GuLiCode has the sole right to decide whether you are
              ...
              <p>
                GuLiCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (GuLiCode and all such
                parties together, the "GuLiCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the GuLiCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The GuLiCode Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the GuLiCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without GuLiCode's prior written
              ...
              <p>
                ...
                disputes and claims with GuLiCode and limits the manner in which you can seek relief from GuLiCode. Both
                you and GuLiCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, GuLiCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. GuLiCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. GuLiCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or GuLiCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and GuLiCode are instead choosing to have claims and disputes resolved by
                ...
                you and GuLiCode over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                GuLiCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or GuLiCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and GuLiCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the GuLiCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and GuLiCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and GuLiCode, and
                ...
                are not an employee, agent, partner, or joint venture of GuLiCode, and you do not have any authority of
                any kind to bind GuLiCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and GuLiCode
