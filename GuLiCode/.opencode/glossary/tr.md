...
- `GuLiCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `GuLiCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `GuLiCode` inside commands, URLs, package names, or code literals
